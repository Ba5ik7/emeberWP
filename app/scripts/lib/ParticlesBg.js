/**
 * Generates random particles using self.canvas
 * 
 * @class Particles
 * @constructor
 */
...
Particles.prototype.createCircle = function(){
  ...
  for (var i = 0; i < this.numParticles; i++) {
    ...
    //once values are determined, draw particle on self.canvas
...
/**
 * Draws particles on self.canvas
...
/**
 * Clears self.canvas between animation frames
 * @method clearCanvas
 */
